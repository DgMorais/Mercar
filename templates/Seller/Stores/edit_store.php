...
<div class="main-wrapper">
    <div class="container my-3">
        <h4 class="text-center text-primary"><strong>Editar loja</strong></h4>
    </div>
    <div class="container my-3 p-2 border rounded">
        <?=$this->Form->create($store,
            [
                'method' => 'POST',
                'url' => ['controller' => 'Stores', 'action' => 'editStore', 'prefix' => 'seller', $store->id],
            ]
        )?>
            <div class="row">
                <div class="col-12">
                    <div class="row">
                        <div class="col-10 d-flex justify-content-center align-items-center">
                            <h3 class="text-center text-primary"><?= $store->nome ?></h3>
                        </div>
                        <div class="col-2">
                            <label class="text-primary small m-0"><?= __('Status da loja') ?></label>
                            <?=$this->Form->control('status',
                                [
                                    'templates' => [
                                        'checkboxContainer' => '<div class="form-check form-switch"{{attrs}}>{{content}}</div>',
                ...
                <div class="col-12 d-flex">
                    <div class="col-4 d-flex justify-content-center">
                        <img src="/img/store/store-icon-image.jpg" for="logo" class="preview-logo-upload">
                    </div>
                    <div class="col-7 d-flex align-items-center">
                        <div>
                            <label class="text-primary">Clique na imagem para alterar a imagem ou logomarca da sua loja</label>
